                        ...
                        <div class="nk-block-head nk-block-head-sm">
                            <div class="nk-block-between">
                                <div class="nk-block-head-content">
                                    <h3 class="nk-block-title page-title">R & D Programs</h3>
                                        ...
                                        <div class="toggle-expand-content" data-content="pageMenu">
                                            <ul class="nk-block-tools g-3">
                                                ...
                                                <li class="nk-block-tools-opt">
                                                    ...
                                                    data-method="get"
                                                    data-action-url="{{ route('admin.r-and-d-program.create') }}">
                                                        <em class="icon ni ni-plus"></em><span>Add R & D Program</span></a>
                                                </li>
                            ...
                            <div class="card card-bordered card-stretch">
                                <div class="card-inner-group">
                                    <div class="card-inner p-0">
                                        <table class="datatable-init1 table" id="r-and-d-program-table">
                                            <thead>
    ...
    <script src="https://cdn.datatables.net/1.10.16/js/jquery.dataTables.min.js"></script> 
        ...
        <script> 
            $(document).ready(function() {
                ...
                $(function() {
                    var table = $('#r-and-d-program-table').DataTable({
                        ajax: {
                            url: "{{ route('admin.r-and-d-program.datatable') }}",
                        },
                        processing: false,
                        serverSide: true,
                        scrollX: false,
                        ...
                        language: {
                            ...
                            info: "",
                            emptyTable: "No R & D Program Available",
                            infoFiltered: "",
                            select: {
                                rows: {
                                    _: " (%d rows selected)",
                        ...
                        "drawCallback": function(settings) {
                            ...
                            $('#r-and-d-program-table_paginate').css({
                                'padding': '10px 25px'
                            });
                        }
                    });
