<form action="{{ route('admin.after-school.store') }}" method="POST" id="after-school-form"
    ...
    <div class="modal-header align-center">
        <div class="nk-file-title">
            ...
            <div class="nk-file-name">
                <div class="nk-file-name-text"><span class="title">Add After School</span></div>
            </div>
        </div>
    ...
    <div class="modal-body">
        ...
        <div class="form-group">
            ...
            <div class="form-control-wrap">
                <input type="text" placeholder="Enter Where" class="form-control" name="where">
            </div>
        </div>  
        <div class="form-group">
            <label class="form-label" for="when">When</label>
            <div class="form-control-wrap">
                <input type="text" placeholder="Enter When" class="form-control" name="when">
            </div>
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
            ...
            <div class="form-control-wrap">
                <textarea name="description" data-feature="all" id="summernote" required></textarea>
            </div>
        </div>
    </div><!-- .modal-body -->
