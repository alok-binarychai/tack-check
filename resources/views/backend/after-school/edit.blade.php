<form action="{{ route('admin.after-school.update', $afterSchool->id) }}" method="POST" id="after-school-form"
    enctype="multipart/form-data" data-form="ajax-form" data-datatable="#after-school-table" data-modal="#ajax_model">
    @csrf
    @method('put')
    <div class="modal-header align-center">
        <div class="nk-file-title">
            ...
            <div class="nk-file-name">
                <div class="nk-file-name-text"><span class="title">Update After School</span></div>
            </div>
        </div>
    ...
    <div class="modal-body">
        ...
        <div class="form-group">
            ...
            <div class="form-control-wrap">
                <input type="text" placeholder="Enter Full Name" class="form-control" value="{{$afterSchool->name}}" name="name" required>
            </div>
        </div>
        <div class="form-group">
            <label class="form-label" for="where">Where</label>
            <div class="form-control-wrap">
                <input type="text" placeholder="Enter Where" class="form-control" value="{{$afterSchool->where}}" name="where">
            </div>
        </div>
        <div class="form-group">
            <label class="form-label" for="when">When</label>
            <div class="form-control-wrap">
                <input type="text" placeholder="Enter When" class="form-control" value="{{$afterSchool->when}}" name="when">
            </div>
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
            ...
            <div class="form-control-wrap">
                <textarea name="description" data-feature="all" id="summernote" required>{!! $afterSchool->description !!}</textarea>
            </div>
        </div>
