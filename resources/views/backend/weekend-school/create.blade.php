<form action="{{ route('admin.weekend-school.store') }}" method="POST" id="weekend-school-form"
    ...
    <div class="modal-header align-center">
        <div class="nk-file-title">
            ...
            <div class="nk-file-name">
                <div class="nk-file-name-text"><span class="title">Add Weekend School</span></div>
            </div>
        </div>
