                        ...
                        <div class="nk-block-head nk-block-head-sm">
                            <div class="nk-block-between">
                                <div class="nk-block-head-content">
                                    <h3 class="nk-block-title page-title">Key Dates</h3>
                                        ...
                                        <div class="toggle-expand-content" data-content="pageMenu">
                                            <ul class="nk-block-tools g-3">
                                                ...
                                                <li class="nk-block-tools-opt">
                                                    ...
                                                    data-method="get"
                                                    data-action-url="{{ route('admin.key-date.create') }}">
                                                        <em class="icon ni ni-plus"></em><span>Add Key Date</span></a>
                                                </li>
                            ...
                            <div class="card card-bordered card-stretch">
                                <div class="card-inner-group">
                                    <div class="card-inner p-0">
                                        <table class="datatable-init1 table" id="key-date-table">
                                            <thead>
                                                <tr class="nk-tb-item nk-tb-head">
                                                    <th class="nk-tb-col py-2"><span class="sub-text">Sr No.</span></th>
                                                    <th class="nk-tb-col py-2"><span class="sub-text">School Name</span></th>
    ...
    <script src="https://cdn.datatables.net/1.10.16/js/jquery.dataTables.min.js"></script> 
        ...
        <script> 
            $(document).ready(function() {
                ...
                $(function() {
                    var table = $('#key-date-table').DataTable({
                        ajax: {
                            url: "{{ route('admin.key-date.datatable') }}",
                        },
                        processing: false,
                        serverSide: true,
                        scrollX: false,
                        ...
                        language: {
                            ...
                            info: "",
                            emptyTable: "No Key Date Available",
                            infoFiltered: "",
                            select: {
                                rows: {
                                    _: " (%d rows selected)",
