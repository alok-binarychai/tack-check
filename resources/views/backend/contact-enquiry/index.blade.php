                        ...
                        <div class="nk-block-head nk-block-head-sm">
                            <div class="nk-block-between">
                                <div class="nk-block-head-content">
                                    <h3 class="nk-block-title page-title">Contact Enquiry</h3>
    ...
    <script src="https://cdn.datatables.net/1.10.16/js/jquery.dataTables.min.js"></script> 
        ...
        <script> 
            $(document).ready(function() {
                ...
                $(function() {
                    var table = $('#contactEnquiry-table').DataTable({
                        ajax: {
                            url: "{{ route('admin.contact-enquiry.datatable') }}",
                        },
                        processing: false,
                        serverSide: true,
                        scrollX: false,
                        ...
                        language: {
                            ...
                            info: "",
                            emptyTable: "No Contact Enquiry Available",
                            infoFiltered: "",
                            select: {
                                rows: {
                                    _: " (%d rows selected)",
                        ...
                        "drawCallback": function(settings) {
                            ...
                            $('#contactEnquiry-table_paginate').css({
                                'padding': '10px 25px'
                            });
                        }
                    });
