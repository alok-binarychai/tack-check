                        ...
                        <div class="nk-block-head nk-block-head-sm">
                            <div class="nk-block-between">
                                <div class="nk-block-head-content">
                                    <h3 class="nk-block-title page-title">Testimonials</h3>
                                        ...
                                        <div class="toggle-expand-content" data-content="pageMenu">
                                            <ul class="nk-block-tools g-3">
                                                ...
                                                <li class="nk-block-tools-opt">
                                                    ...
                                                    data-method="get"
                                                    data-action-url="{{ route('admin.testimonial.create') }}">
                                                        <em class="icon ni ni-plus"></em><span>Add Testimonial</span></a>
                                                </li>
                            ...
                            <div class="card card-bordered card-stretch">
                                <div class="card-inner-group">
                                    <div class="card-inner p-0">
                                        <table class="datatable-init1 table" id="testimonial-table">
                                            <thead>
            ...
            $(document).ready(function() {
                ...
                $(function() {
                    var table = $('#testimonial-table').DataTable({
                        ajax: {
                            url: "{{ route('admin.about.testimonial.datatable') }}",
                        },
                        processing: false,
                        serverSide: true,
                        scrollX: false,
                        ...
                        language: {
                            ...
                            info: "",
                            emptyTable: "No Testimonial Available",
                            infoFiltered: "",
                            select: {
                                rows: {
                                    _: " (%d rows selected)",
                        ...
                        "drawCallback": function(settings) {
                            ...
                            $('#testimonial-table_paginate').css({
                                'padding': '10px 25px'
                            });
                        }
                    });
