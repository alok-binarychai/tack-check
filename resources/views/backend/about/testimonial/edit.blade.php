<form action="{{ route('admin.testimonial.update', $testimonial->id) }}" method="POST" id="testimonial-form"
    ...
    <div class="modal-header align-center">
        <div class="nk-file-title">
            ...
            <div class="nk-file-name">
                <div class="nk-file-name-text"><span class="title">Update Testimonial</span></div>
            </div>
        </div>
    ...
    <div class="modal-body">
        ...
        <div class="form-group">
            ...
            <div class="form-control-wrap">
                <input type="text" placeholder="Enter Full Name" class="form-control" value="{{$testimonial->name}}" name="name" required>
            </div>
        </div>
        <div class="form-group">
            <label class="form-label" for="email-address-1">Description</label>
            <div class="form-control-wrap">
                <textarea name="description" class="form-control" required> {{$testimonial->description}}
                </textarea>
            </div>
        </div>
